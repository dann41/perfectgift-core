...
public class Constants {
	...
	public static final String TEXTURE_ATLAS_BACKGROUND = "images/backgrounds.pack";
	public static final String TEXTURE_ATLAS_GAMEUI = "images/gameui.pack";
	
	public static final String TEXTURE_ATLAS_DITS = "images/dits.pack";
	
	public static final String TEXTURE_ATLAS_UI = "images/menu.pack";
	public static final String TEXTURE_ATLAS_LIBGDX_UI = "images/uiskin.atlas";
	public static final String TEXTURE_ATLAS_THUMBNAILS = "images/thumbnails.pack";
	
	// Location of description file for skins
	public static final String SKIN_LIBGDX_UI = "images/uiskin.json";
	public static final String SKIN_DITS_UI = "images/menu.json";
	public static final String SKIN_THUMBNAILS_UI = "images/thumbnails.json";
	

	// Location of image file for level 01
	public static final String LEVEL_01 = "levels/level01.properties";
